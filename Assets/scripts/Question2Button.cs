...
public class Question2Button : MonoBehaviour
{
    private AudioClip micClip;
    private string micDevice;
    private bool isRecording = false;
    private MicDoor[] micDoors;
    [SerializeField] private string targetPhrase = "41";
    public TextMeshPro transcriptText;

    public GameObject micStatusIcon;

    void Start(){
        GameObject[] doorObjects = GameObject.FindGameObjectsWithTag("Question2Door");

        if (doorObjects.Length == 0)
        {
            Debug.LogError("No doors with tag 'Question2Door' found!");
        }
